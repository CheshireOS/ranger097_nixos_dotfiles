...
const float GLOW_CUTOFF_DISTANCE = 0.18;
const float GLOW_CUTOFF_SOFTNESS = 0.9;

// Dithering Strength
const float DITHER_STRENGTH = 1.0 / 50.0;

// Opacity settings
const float GLOW_OPACITY = 0.9;
...
const float AURORA_BRIGHTNESS = 0.5;
...
const float DRAC_BRIGHTNESS = 0.2;
...
const float MONO_BRIGHTNESS = 1.0;
