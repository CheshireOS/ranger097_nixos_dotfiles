...
try:
    if x == 0:
        subprocess.Popen(["waybar", "-c", "/persist/home/ranger/ranger097_nixos_dotfiles/waybar/top.jsonc", "-s", "/persist/home/ranger/ranger097_nixos_dotfiles/waybar/top.css"])
        ...
        subprocess.Popen(["waybar", "-c", "/persist/home/ranger/ranger097_nixos_dotfiles/waybar/bottom.jsonc", "-s", "/persist/home/ranger/ranger097_nixos_dotfiles/waybar/bottom.css"])
        with open(toggle_file, 'w') as f:
            f.write("2")
    elif x == 2:
        subprocess.run(["pkill", "waybar"])
